...
?>
	<span class="hikashop_filter_button_outside" <?php echo $style; ?>>
		<input type="submit" id="hikashop_filter_button_<?php echo $this->params->get('main_div_name'); ?>" class="uk-button uk-button-default <?php echo $this->config->get('css_button', 'hikabtn'); ?>" onclick="<?php echo $js; ?>" <?php echo $attributes; ?> value="<?php echo JText::_('FILTER'); ?>" />
	</span>
<?php
		}
		if($this->showResetButton){
...
?>
	<span class="hikashop_reset_button_outside" <?php echo $style; ?>>
		<a href="#" id="hikashop_reset_button_<?php echo $this->params->get('main_div_name'); ?>" class="uk-button uk-button-default <?php echo $this->config->get('css_button', 'hikabtn'); ?>" onclick="<?php echo $js; ?>" <?php echo $attributes; ?> ><?php echo JText::_('RESET'); ?></a>
	</span>
<?php
		}
	}

...
?>
    ...
    <!-- EO VOTE -->
    <!-- DESCRIPTION -->
    <div class="hikashop_product_desc uk-margin" itemprop="description"><?php
        echo mb_substr(strip_tags(preg_replace('#<hr *id="system-readmore" */>.*#is', '', $this->row->product_description)), 0, 100, 'UTF-8') .'...' ;
        ?></div>
    <!-- EO DESCRIPTION -->
    <!-- ADD TO CART BUTTON -->
    <?php

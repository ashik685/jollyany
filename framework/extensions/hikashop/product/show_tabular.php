...
<?php if(!empty($description) || !empty ($this->element->product_url)) {
		if(empty($selected)) $selected = 'hikashop_show_tabular_description'; ?>
			<li id="hikashop_show_tabular_description_li" class="hikashop-tabs-li"><a href="#"><?php echo JText::_('PRODUCT_DESCRIPTION');?></a></li>
<?php } ?>
<!-- EO DESCRIPTION TAB TITLE -->
<!-- SPECIFICATION TAB TITLE -->
<?php if(!empty($specif_tab_content)) {
		if(empty($selected)) $selected = 'hikashop_show_tabular_specification'; ?>
			<li id="hikashop_show_tabular_specification_li" class="hikashop-tabs-li"><a href="#"><?php echo JText::_('SPECIFICATIONS');?></a></li>
<?php } ?>
...
<!-- EO VOTE TAB TITLE -->
        ...
        <ul class="uk-switcher uk-margin-medium">
            ...
            if($status_vote == "comment" || $status_vote == "two" || $status_vote == "both" ) { ?>
                <li class="hikashop-tabs-content uk-animation-slide-bottom-small" id="hikashop_show_tabular_comment">

...
array(
	'type'=>'content',
	'addon_name'=>'sp_feature_section',
	'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_FEATURE_SECTION'),
	...
	'attr'=>array(
		'general' => array(
            ...
            'image_size'=>array(
                'type'=>'select',
                'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_IMAGE_CONTENT_IMAGE_SIZE'),
                'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_IMAGE_CONTENT_IMAGE_SIZE_DESC'),
                'values'=>array(
                    'cover'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_COVER'),
                    'contain'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_CONTAIN'),
                ),
                'std'=>'cover',
            ),

...
SpAddonsConfig::addonConfig(
	array(
		'type'=>'repeatable',
		'addon_name'=>'sp_testimonialcarousel',
		...
		'attr'=>array(
			'general' => array(
                ...
                'testimonial_type'=>array(
                    'type'=>'select',
                    'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_TYPE'),
                    'values' =>array(
                        'slides'=>JText::_('TESTIMONIAL_FLEXSLIDER'),
                        'owl-carousel'=>JText::_('TESTIMONIAL_CAROUSEL'),
                    ),
                    'std' => 'slides'
                ),
                'show_quote'=>array(
                ...
                'boxshadow_background'=>array(
                    'type'=>'color',
                    'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_BOXSHADOW_BACKGROUND'),
                    'std'=>'rgba(85, 152, 255, 0.1)'
                ),
				...
				'sp_testimonialpro_item'=>array(
					...
					'attr'=>array(
						...
						'designation'=>array(
							'type'=>'text',
							'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_CLIENT_DESIGNATION'),
							'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_CLIENT_DESIGNATION_DESC'),
						),

                        'image'=>array(
                            'type'=>'media',
                            'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_CLIENT_FEATURE_IMAGE'),
                            'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_CLIENT_FEATURE_IMAGE_DESC'),
                        ),
				...
				'name_separator'=>array(
					'type'=>'separator',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_CLIENT_NAME_OPTIONS'),
				),
				'name_color'=>array(
					'type'=>'color',
				...
				'designation_block'=>array(
					'type'=>'checkbox',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_DESIGNATION_BLOCK'),
					'std'=>0,
				),
				...
				'designation_font_style'=>array(
					'type'=>'fontstyle',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_DESIGNATION_FONTSTYLE'),
				),
				'designation_font_family'=>array(
					...
					'selector'=> array(
						'type'=>'font',
						'font'=>'{{ VALUE }}',
						'css'=>'.sppb-addon-testimonial-pro-client-designation { font-family: "{{ VALUE }}"; }'
					)
				),
				'designation_margin'=>array(
					'type'=>'margin',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_DESIGNATION_MARGIN'),
					'responsive'=>true,
					'std'=>''
				),
				//Content

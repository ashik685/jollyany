   ...
   <div class="logo-wrapper">
      <a target="<?php echo $logo_link_target; ?>" class="<?php echo implode(' ', $class); ?><?php echo $mr; ?>" href="<?php echo $logo_link; ?>">
         <?php if (!empty($default_logo)) { ?>
            <img src="<?php echo JURI::root() . Astroid\Helper\Media::getPath() . '/' . $default_logo; ?>" alt="<?php echo $sitename; ?>" <?php echo JFile::getExt($default_logo) == 'svg' ? 'uk-svg' : ''; ?> class="astroid-logo-default" />
         <?php } ?>
         <?php if (!empty($mobile_logo)) { ?>
            <img src="<?php echo JURI::root() . Astroid\Helper\Media::getPath() . '/' . $mobile_logo; ?>" alt="<?php echo $sitename; ?>" <?php echo JFile::getExt($mobile_logo) == 'svg' ? 'uk-svg' : ''; ?> class="astroid-logo-mobile" />
         <?php } ?>
         <?php if (!empty($stickey_header_logo)) { ?>
            <img src="<?php echo JURI::root() . Astroid\Helper\Media::getPath() . '/' . $stickey_header_logo; ?>" alt="<?php echo $sitename; ?>" <?php echo JFile::getExt($stickey_header_logo) == 'svg' ? 'uk-svg' : ''; ?> class="astroid-logo-sticky" />
         <?php } ?>
      </a>
   </div>
   <!-- image logo ends -->

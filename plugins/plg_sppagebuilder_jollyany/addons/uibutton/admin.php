...
SpAddonsConfig::addonConfig(
    array(
      'type' => 'general',
      'addon_name' => 'uibutton',
      'title' => JText::_('UI Button'),
      'desc' => JText::_('Easily create nice looking buttons, which come in different styles.'),
      'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uibutton/assets/images/icon.png',
      'category' => 'Jollyany',
      'attr' => array(
          'general' => array(
            'admin_label' => array(
            ...
            'ui_list_buttons' => array(
              ...
              'attr' =>  array(
                ...
                'icon_position' => array(
                    ...
                    'values' => array(
                        '' => JText::_('COM_SPPAGEBUILDER_GLOBAL_LEFT'),
            ...
            'grid_column_gap' => array(
                ...
                'desc' => JText::_('Set the size of the column gap between multiple buttons.'),
                'values' => array(
                    'small' => JText::_('Small'),
            ...
            'grid_row_gap' => array(
                ...
                'desc' => JText::_('Set the size of the row gap between multiple buttons.'),
                'values' => array(
                    'small' => JText::_('Small'),
                    'medium' => JText::_('Medium'),
                    '' => JText::_('Default'),
            ...
            'button_alignment' => array(
                ...
                'desc' => JText::_('Center, left and right alignment may depend on a breakpoint and require a fallback.'),
                'values' => array(
                    '' => JText::_('None'),
                    'left' => JText::_('Left'),
                    'center' => JText::_('Center'),

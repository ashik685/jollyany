...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uicard',
		'title' => JText::_('UI Card'),
		'desc' => JText::_('Create layout boxes with different styles.'),
		'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uicard/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				...
				'label_text' => array(
					'type' => 'text',
					'title' => JText::_('Label'),
					'desc' => JText::_('To position a badge inside a card.'),
					'std' => '',
				),
				'label_styles' => array(
					'type' => 'select',

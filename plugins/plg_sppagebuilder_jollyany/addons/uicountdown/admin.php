...
SpAddonsConfig::addonConfig(
	array(
		...
		'title' => JText::_('UI Countdown'),
		'desc' => JText::_('Create a simple countdown timer.'),
		'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uicountdown/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'date' => array(
					'type' => 'text',
					'title' => JText::_('Date'),
					'desc' => JText::_('Enter a date for the countdown to expire. Use the ISO 8601 format: YYYY-MM-DDThh:mm:ssTZD, e.g. 2017-05-01T22:00:00+00:00 (UTC time).'),
				...
				'minutes' => array(
					'type' => 'text',
					'title' => JText::_('Minutes'),
					'std' => 'Minutes',
				),
				'seconds' => array(
					'type' => 'text',
					'title' => JText::_('Seconds'),
					'std' => 'Seconds',
				),
				'show_label' => array(
					'type' => 'checkbox',
					'title' => JText::_('Show Labels'),
					'desc' => JText::_('Show/Hide labels for the countdown time.'),
					'values' => array(
						1 => JText::_('JYES'),
						0 => JText::_('JNO'),
					),
				...
				'number_color' => array(
					...
					'desc' => JText::_('Select the predefined number text color.'),
					'values' => array(
						'' => JText::_('None'),
						'uk-text-muted' => JText::_('Muted'),
						'uk-text-emphasis' => JText::_('Emphasis'),
						'uk-light' => JText::_('Light'),
						'uk-text-primary' => JText::_('Primary'),
						'uk-text-secondary' => JText::_('Secondary'),
						'uk-text-success' => JText::_('Success'),
						'uk-text-warning' => JText::_('Warning'),
						'uk-text-danger' => JText::_('Danger'),
					),
					'std' => '',
				),

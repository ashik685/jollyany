...
class SppagebuilderAddonUiTestimonialSlider extends SppagebuilderAddons {
	...
	public function render() {
		...
		$output .= '<div class="ui-testimonial-slider' . $zindex_cls . $general . $max_width_cfg . '"' . $animation . ' uk-slider="' . $autoplay . $slide_sets . $center_items . $finite_slide . $velocity_init . '">';
		if ( $title_addon ) {
		...
		foreach ( $settings->ui_testimonialslider_item as $key => $value ) {
			...
			$output .= '<li class="ui-testimonial' . $grid_ts . '">';

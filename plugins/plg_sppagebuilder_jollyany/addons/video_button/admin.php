...
SpAddonsConfig::addonConfig(
	array(
		...
		'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_VIDEO_BUTTON'),
		'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_VIDEO_BUTTON_DESC'),
		...
		'attr'=>array(
			'general' => array(
				...
				'video_url'=>array(
					'type'=>'text',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_VIDEO_BUTTON_URL'),
					'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_VIDEO_BUTTON_URL_DESC'),
					'std'=> ''
				),

				'video_fontsize'=>array(
					'type'=>'slider',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_VIDEO_ICON_SIZE'),
					'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_VIDEO_ICON_SIZE'),
					'std'=>'',
					'max'=>400,
